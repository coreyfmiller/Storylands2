...
const rawBook: Book = {
  ...
  pages: [
    ...
    },
    {
      ...
      manifest: {
        charactersPresent: ['oliver'],
        location: 'the living room, behind a leafy potted houseplant',
        timeOfDay: 'midday',
        action: 'Oliver peeks out from behind a potted houseplant, only his eyes and nose and one ear showing, watching the vacuum intently',
        emotionalBeat: 'sneaky, tactical, comic surveillance',
        requiredVisualFacts: ['Oliver peeking out from behind a leafy potted houseplant', 'only part of his face and one ear visible', 'the vacuum across the room'],
        forbiddenVisualFacts: [...forbiddenAlways, 'a real monster'],
        composition: 'plant in the foreground with Oliver peeking; the vacuum small in the background',
      },
    },
    {
      page: 6,
