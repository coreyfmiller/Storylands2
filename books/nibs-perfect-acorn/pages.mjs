...
export const pages = [
  ...
  },
  {
    ...
    requiredVisualFacts: ['a tiny green sprout in a patch of earth', 'an absurd little protective fence or barrier built around the sprout', 'Nibs standing guard proudly', 'Tilly watching with a knowing amused expression', 'a small blank wooden sign staked beside the patch with no writing on it'],
    ...
    composition: 'morning light, comic reversal; Nibs guarding the sprout, Tilly observing; the blank sign visible',
  },
]
