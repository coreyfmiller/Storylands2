...
const rawBook: Book = {
  ...
  pages: [
    ...
    {
      page: 13,
      text: `By morning, the little sprout had a fence, a guard, and a small blank sign that clearly meant: nothing important here, definitely no future trees.\n\nTilly looked at the sign. Then at the fence. Then at Nibs.\n\nHe had not changed quite as much as she had hoped.`,
      art: '',
      manifest: {
        charactersPresent: ['nibs', 'tilly'],
        location: 'the clearing next morning, a small fenced-off patch of earth with the sprout',
        timeOfDay: 'morning',
        action: 'Nibs stands guard proudly beside a tiny fenced patch protecting the little sprout, having built an absurd little barrier around it; Tilly watches from a branch with a knowing, amused look',
        emotionalBeat: 'affectionate comic callback: he is still exactly himself',
        requiredVisualFacts: ['a tiny green sprout in a patch of earth', 'an absurd little protective fence/barrier Nibs has built around the sprout', 'Nibs standing guard proudly', 'Tilly watching with a knowing, amused expression', 'a small blank wooden sign staked beside the patch (NO readable text on it)'],
        forbiddenVisualFacts: ['frightening or dark imagery', 'human characters', 'Nibs wearing clothing', 'readable words or letters anywhere in the image', 'a fully grown tree'],
        composition: 'morning light, comic reversal; Nibs guarding the sprout, Tilly observing; the blank sign clearly visible (textless)',
      },
    },
  ],
}
