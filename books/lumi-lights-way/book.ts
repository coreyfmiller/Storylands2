  ...
  pages: [
    ...
    },
    {
      ...
      manifest: {
        ...
        timeOfDay: 'night',
        action: 'The tiny firefly brightens its own small warm glow beside Lumi, lighting a little circle in the dark; Lumi looks at it with surprise and dawning hope',
        emotionalBeat: 'the turn: the little one has a light of its own',
        requiredVisualFacts: ['the tiny firefly glowing brightly with its own small light', 'a little circle of warm light in the dark', 'Lumis surprised, hopeful face lit by it'],
        forbiddenVisualFacts: [...forbiddenAlways],
        composition: 'the firefly the small warm light source, Lumi leaning toward it hopefully, soft dark around',
      },
    },
    {
      page: 8,
